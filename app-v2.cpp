...
int run(){
    ...
    cout << "====================================\n";
    cout << "A. Book Ticket (Add Passenger)\n";
    cout << "B. Schedule Flight (Add to Tracker)\n";
    cout << "C. Display All Passengers\n";
    cout << "D. Display Flight Board\n";
    cout << "E. Search Passenger\n";
    cout << "F. Cancel Booking (Delete Passenger)\n";
    cout << "G. Exit System\n\n";
    cout << "Enter Choice: ";
    cin >> choice;
    cout << "---" << choice << "----" << endl;
